module SecureApi
  class ApiServer < EM::Connection
    ...
    def authorize_request
      ...
      if defined?(IGNORE_AUTH_PARAMS) && IGNORE_AUTH_PARAMS
        check_params = params.select {|k,v| !IGNORE_AUTH_PARAMS.include?(k)}
      end
    ...
    def send_response res, response
      ...
      response.headers = res[:headers] if res[:headers]
